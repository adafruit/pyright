    ...
    private _tryNumber(): boolean {
        ...
        if (this._cs.currentChar === Char._0) {
            ...
            if (radix > 0) {
                ...
                if (!isNaN(value)) {
                    this._tokens.push(NumberToken.create(start, text.length, text, value, radix, true, this._getComments()));
                    return true;
                }
            }
        }
        ...
        if (isDecimalInteger) {
            ...
            if (!isNaN(value)) {
                this._tokens.push(NumberToken.create(start, text.length, text, value, 10, true, this._getComments()));
                return true;
            }
        }
        ...
        if (mightBeFloatingPoint ||
            ...
            if (this._skipFloatingPointCandidate()) {
                ...
                if (!isNaN(value)) {
                    this._tokens.push(NumberToken.create(start, this._cs.position - start, text, value,
